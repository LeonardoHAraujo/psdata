	...
	try {
		...
		$bodyMessage = "<!DOCTYPE html>
			...
			<body>
				<div class='container'>
					...
					<p class='ola'>
						Ola! <b>$(name)</b> esta pessoa/empresa solicita seu suporte,
					</p>
		...
		$infos = "
			<ul>
				<li>Nome: $name</li>
				<li>Email: $email</li>
				<li>Título do serviço: $service</li>
			</ul>
		";

		$bodyMessage = str_replace('$(name)', 'Pablo PSDATA', $bodyMessage);
		$bodyMessage = str_replace('$(infos)', $infos, $bodyMessage);
		$bodyMessage = str_replace('$(message)', $description, $bodyMessage);

		$mail->isHTML(true);      
		$mail->Subject = 'Suporte PSDATA';

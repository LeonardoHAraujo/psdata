    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Shipping</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <!-- Column -->
                    <div class="col-lg-8 col-xlg-9 col-md-12" style="margin: auto">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" id="formShipping" action="../../data/SendFileByEmail.php" method="POST" enctype="multipart/form-data">
                                    <div id="alert-form" class="alert hide" role="alert" style="width: 100%;margin: auto;">
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Arquivos</label>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" type="submit" id="send" style="margin-left: -1%;">Send Email</button>
                                        </div>
                                    </div>
                                </form>
                            </div>

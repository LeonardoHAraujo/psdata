...
<body>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="password" id="password" placeholder="Password..." class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" id="updtProfile" style="margin-left: -1%;">Update Profile</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="js/credupdt.js"></script>
</body>
